...
export type GetAnimalListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAnimalListQuery = { __typename?: 'Query', animals?: { __typename?: 'AnimalsConnection', edges: Array<{ __typename?: 'AnimalEdge', node?: { __typename?: 'Animal', name?: string | null | undefined, id: number } | null | undefined }> } | null | undefined };


export const GetAnimalListDocument = gql`
    query GetAnimalList {
  animals {
    edges {
      node {
...
/**
 * __useGetAnimalListQuery__
 *
 * To run a query within a React component, call `useGetAnimalListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAnimalListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAnimalListQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAnimalListQuery(baseOptions?: Apollo.QueryHookOptions<GetAnimalListQuery, GetAnimalListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAnimalListQuery, GetAnimalListQueryVariables>(GetAnimalListDocument, options);
      }
export function useGetAnimalListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAnimalListQuery, GetAnimalListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAnimalListQuery, GetAnimalListQueryVariables>(GetAnimalListDocument, options);
        }
export type GetAnimalListQueryHookResult = ReturnType<typeof useGetAnimalListQuery>;
export type GetAnimalListLazyQueryHookResult = ReturnType<typeof useGetAnimalListLazyQuery>;
export type GetAnimalListQueryResult = Apollo.QueryResult<GetAnimalListQuery, GetAnimalListQueryVariables>;